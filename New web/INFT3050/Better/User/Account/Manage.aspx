<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="Better.Manage" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div >
                <asp:CheckBox ID="CheckBox" runat="server"  OnCheckedChanged="Check_Clicked" CssClass="Cbox"/>
                <div Style="padding-top:2px; padding-left:40px;">
                    <p>Show Name in <br /> Hall Of Heros</p>
                </div>
            </div>
        </div>
    </div>
